...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColorsGlass(ImGuiStyle* dst = NULL);           // janekb04's dark style
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool lever = true);
    ...
    IMGUI_API bool          BeginListBox(const char* label, const ImVec2& size = ImVec2(0, 0), ImGuiWindowFlags extra_flags = 0); // open a framed scrolling region
    IMGUI_API void          EndListBox();                                                       // only call EndListBox() if BeginListBox() returned true!
    IMGUI_API bool          ListBox(const char* label, int* current_item, const char* const items[], int items_count, int height_in_items = -1);
    IMGUI_API bool          ListBox(const char* label, int* current_item, bool (*items_getter)(void* data, int idx, const char** out_text), void* data, int items_count, int height_in_items = -1, ImGuiWindowFlags extra_flags = 0);
...
enum ImGuiWindowFlags_
{
    ...
    // [Shadows] [Azurre]
    ImGuiWindowFlags_NoShadows              = 1 << 30,  // Disable shadows of this window
};
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddLineShadow(const ImVec2& p1, const ImVec2& p2, ImU32 col, ImU32 shadow_col, float thickness = 1.f, float shadow_thickness = 1.f);
    IMGUI_API void  AddLineMultiColor(const ImVec2& p1, const ImVec2& p2, ImU32 col1, ImU32 col2, float thickness = 1.0f, int segments = 16);
    IMGUI_API void  AddLineMultiColorShadow(const ImVec2& p1, const ImVec2& p2, ImU32 col1, ImU32 col2, ImU32 shadow_col1, ImU32 shadow_col2, float thickness = 1.0f, float shadow_thickness = 1.f, int segments = 16);
